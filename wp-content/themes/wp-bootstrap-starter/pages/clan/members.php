...
<?php 
	...
	<div class="col-md-1 celBlock">
		<?php if($declarer_ID == $clanleader && $declarer_ID != $userId){?>
			<a href="/kick.php/?id=<?php echo $userId;?>&clan=<?php echo $clan_id;?>" onclick="return confirm('Are you sure you want to kick <?php echo $member_data->display_name.' (#'.$userId.')';?> from your clan? Your clan will lose <?php echo round($pts*0.25);?> clan points.')">Kick</a>
		<?php } ?>

...
<div class="row unitRow headerRow" style="border-bottom:1px solid #fff;background-color: rgba(<?php echo $backColor;?>, 0.75);">
	...
	<?php foreach ($attackArray as $unitKey => $unit) {?>
	...
	<?php }?>
			...
			<?php if(array_key_exists('tomahawk', $_POST['attackarray'])){?>
...
<?php if($attackType == 'sniper'): $attackArray = $_POST['attackarray']; ?>

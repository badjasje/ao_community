<?php if(!in_array($startingbonus, $boni)): // Check if player has starting bonus ?>
	...
	<div class="startingBonusPicker">
	    <div id="startingBonus" class="blockHeader">
			...
			<h3 style="color:#fff !important;"> Please pick a starting strategy. </h3>
			...
			<strong><a href="./getting-started" target="_blank">Getting Started</a></strong> guide before selecting a bonus/strategy.<br/><br/>
		</div>
...
(function($) {
	...
	$("#pickStartingBonus").submit(function(event){
		...
		request = $.ajax({url: "/startingbonus.php", type: "post", data: serializedData});

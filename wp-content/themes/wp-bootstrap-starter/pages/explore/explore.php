...
$maxAmount = floor((20000-$exploredToday)/(200-((ceil($ownedland*0.002))))); ?>
...
<div class="row no-gutters">
	...
	<div class="col-md-9 no-gutters">
		<div class="row no-gutters">
			...
			<div id="maxexp" class="col-sm-6 bankCol mainSubmit" style="border-top:0px;background-color:rgba(70, 118, 94, 0.8);">
				ALL TURNS
			</div>
		</div>
	</div>

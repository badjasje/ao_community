...
<div class="blockHeader spaceNotice sellNotice">
    ...
    You have sold <strong><?php echo $soldLandToday;?> m<sup>2</sup></strong> today. You can sell an additional <strong><?php echo $maxSell;?> m<sup>2</sup></strong>
</div>
...
<div class="row no-gutters">
	...
	<div class="col-md-9 no-gutters">
		<div class="row no-gutters">
			...
			<div id="maxsell" class="col-sm-6 bankCol mainSubmit" style="border-top:0px;background-color:rgba(70, 118, 94, 0.8);">
				ALL LAND
			</div>
		</div>
	</div>

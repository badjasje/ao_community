...
<div class="row pageRow">
	...
	$args = array(
		...
		'meta_query'	=> array(
			'relation' => 'AND',
			array('key' => 'attacker_id', 'value' => $userId, 'compare' => '='),
	...
	if ($custom_query->have_posts()):
		while ($custom_query->have_posts()):
			...
			<?php elseif($attack_type == 'nukeprotection'): ?>
				<?php include('pages/events/outgoing/protection-removed.php'); ?>
			<?php elseif($attack_type == 'user_kicked'): ?>
				<?php include('pages/events/outgoing/kicked.php'); ?>
			<?php elseif($attack_type == 'sat_crash'): ?>
				<?php include('pages/events/outgoing/satellite-crashed.php'); ?>

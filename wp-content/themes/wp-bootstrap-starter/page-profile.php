...
<div class="row fw-row no-gutters profileButtonRow">
 	<a class="col-md-3 profileButton" style="background-color: rgba(70, 118, 94, 1);" href="/attack/?id=<?php echo $viewedId;?>">
		<i class="fa fa-crosshairs" aria-hidden="true"></i> &nbsp;Attack
	</a>

 	<a class="col-md-3 profileButton" style="background-color: rgba(70, 118, 94, 0.9);"href="/spy-reports/?id=<?php echo $viewedId;?>">
...
<div class="row no-gutters fw-row profileButtonRow">
	<a class="col-md-2 profileButton" style="background-color: rgba(70, 118, 94, 1);" href="/attack/?id=<?php echo $viewedId;?>">
		<i class="fa fa-crosshairs" aria-hidden="true"></i> &nbsp;Attack
	</a>

 	<a class="col-md-2 profileButton" style="background-color: rgba(70, 118, 94, 0.9);"href="/spy-reports/?id=<?php echo $viewedId;?>">
 		<i class="fa fa-binoculars" aria-hidden="true"></i> &nbsp;Spy reports
 	</a>
...
<div class="row fw-row no-gutters profileButtonRow">
	...
	<a class="col-md-4 profileButton" style="background-color: rgba(70, 118, 94, 1);" href="/military-overview/?id=<?php echo $viewedId;?>">

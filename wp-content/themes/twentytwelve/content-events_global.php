...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<center><h1>Events : Global</h1>
		

		<p><a href="/events/incoming/">Incoming</a> | <a href="/events/outgoing/">Outgoing</a> | <a href="/events/global/">Global</a></p></center>
			...
			'meta_query'	=> array(
                         ...
                         array(
                           'key' => 'attacktype',
                           'value' => array('satellite','regular','air_sea','ground','missile'),
                           'compare' => 'IN'
                         ),
                     array(
                           'relation' => 'OR',
			...
			// Define custom query parameters
				...
				<div class="container2">
					...
					<td style="max-width: 280px;">
						...
						<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> attacked
						...
						<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> and 
				...
				<table class="responsive-table">
					...
					<td style="max-width: 280px;">
						...
						<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> launched a missile at
...
<?php elseif($attack_type == 'satellite'):?>
				...
				<table class="responsive-table">
					...
					<td style="max-width: 280px;">
						...
						<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> fired a satellite at

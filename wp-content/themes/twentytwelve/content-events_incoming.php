	...
	<div class="entry-content">
		...
		<p><a href="/events/incoming/">Incoming</a> | <a href="/events/outgoing/">Outgoing</a> | <a href="/events/global/">Global</a></p>
				...
				<table class="responsive-table">
					...
					You were attacked by <a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> and <strong>you died</strong><br/><hr/>
					...
					<td style="text-align:center">
						<?php $member_data = get_userdata($attacker_id[0]);?>
					You were attacked by <a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> and you 
				...
				<table class="responsive-table">
					...
					<td style="text-align:center">
						<?php $member_data = get_userdata($attacker_id[0]);?>
				<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> launched a missile at your base and <strong>you died</strong><br/><hr/>
					...
					<td style="text-align:center">
						<?php $member_data = get_userdata($attacker_id[0]);?>
					<a href="/users/profile/?id=<?php echo $attacker_id[0];?>"><?php echo $member_data->display_name.' (#'.$attacker_id[0].')';?></a> launched a missile at your base and 

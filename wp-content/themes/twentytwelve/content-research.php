...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			...
			<p>One research costs 25 turns. Queuing a research costs an additional 5 turns.</p>
			</center>
		...
		<form class="form" action="<?php echo home_url() ?>/research.php" name="" id="market" method="post">
			...
			<tr>
				...
				<td data-title="Time">
					<?php echo $research['duration'];?> hours
				</td>
				...
				<td data-title="Pick research">
					<?php 
						...
						if($research['maxlevel'] != $current){
						$level = 'level'.($current+1);
						echo "<input type='radio' name='research' value='$key'>";}
				...
				<td data-title="Effect">
					...
					<?php 
						...
						$timestamp = strtotime(date('Y-m-d H:i:s'));
							...
							$researchhours = $research['duration']*3600;
		...
		<form class="form" action="<?php echo home_url() ?>/queue_research.php" name="" id="queue" method="post">
			...
			<tr>
				...
				<td data-title="Time">
					<?php if($max == false){ echo $research['duration'].' hours';}?>
				</td>
				...
				<td data-title="Pick research">
					<?php 
						...
						if($research['maxlevel'] != $current){
						$level = 'level'.($current+1);
						echo "<input type='radio' name='queue' value='$key'>";}}

<div class="spaceNotice">
	Your empty shipyards allow you to build a maximum of <strong><?php echo ($seaspace*5)-count_seaspace($userId);?></strong> sea units.
</div>
	...
	<div class="col-md-1 clan_column">
		...
		<span class="clan_data_right">
				<?php 	$max_money = floor($totalMoney/($order['price']));
						...
						$max_space = ($seaspace*5)-count_seaspace($userId);

<div class="spaceNotice">
	Your empty airfields allow you to build a maximum of <strong><?php echo ($airspace*10)-count_airspace($userId);?></strong> air units.
</div>
...
<?php if($unittype == 'air'):?>
	...
	<div class="col-md-1 clan_column">
		...
		<span class="clan_data_right">
				<?php 	$max_money = floor($totalMoney/($order['price']));
						$max_turns = floor($totalturns*10);
						$max_space = ($airspace*10)-count_airspace($userId);
	...
	<div class="col-md-3 clan_column border_bottom_mobile">
		<input onblur="calculate_<?php echo $key;?>()" class="marketInput buyunits" min="0" type="number" id="<?php echo $key;?>" name="<?php echo $key;?>"/>

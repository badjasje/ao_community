<?php
$unitsOwned = get_user_meta($user_ID, $unitKey.'_owned');
$unitsOrdered = get_user_meta($user_ID, $unitKey.'_ordered');
...
<div class="row clan_profile_row2">
    ...
    <div class="col-md-1 clan_column">
        ...
        <span class="clan_data_right">
            <?php
            $max_money = floor($totalMoney[0] / $buyPrice);
            $max_space = ($infspace[0]*20)-count_infspace($user_ID);
            ?>

            <?php if($unitKey == 'spy' || $unitKey == 'thief' || $unitKey == 'sniper'):?>
                <span class="allbutton" id="button<?php echo $unitKey;?>"><?php echo (min($ccspace,$max_money,$max_space));?></span>
            <?php else:?>
                <span class="allbutton" id="button<?php echo $unitKey;?>"><?php echo (min($max_money,$max_space));?></span>
            <?php endif;?>
        </span>
    </div>
    <div class="col-md-2 clan_column border_bottom_mobile">

            ...
            <div class="col-lg-12 col-md-12">
	         <center><h1><i class="fa fa-line-chart" aria-hidden="true"></i> <?php echo $clan_points;?>pts</h1></center>
			   ...
			   <div id="progress">
				    ...
				    <span class="rdw-line-2">This clan bonus gives each member</span> <span class="rdw-line-2">$<?php echo number_format($bon['money'], 0, ',', ' ');?> and <?php echo $bon['turns'];?> turns.</span>
				    </div>

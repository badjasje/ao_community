...
You attacked <?php echo clan_tag($member_data->ID);?> <a href="/users/profile/?id=<?php echo $member_data->ID;?>"> <?php echo $member_data->display_name.' (#'.$member_data->ID.')';?></a> and you 
...
<?php if($status_defender == 'death'):?>
				...
				<table class="responsive-table">
					...
					<td style="max-width: 280px;"><?php $member_data = get_userdata($defender_id[0]);?>
						You attacked <?php echo clan_tag($member_data->ID);?> <a href="/users/profile/?id=<?php echo $member_data->ID;?>">
...
<?php if($attack_type == 'missile'):?>
				...
				<div class="container2">
					...
					<td style="text-align:center">
						...
						<?php $member_data = get_userdata($defender_id[0]);?>
						You launched a missile at <?php echo clan_tag($member_data->ID);?>
					...
					<?php } else { ?>
						...
						your missile was shot down.
					<?php } else {?>
					you <strong>missed</strong> the enemy base.
					<?php }?>
...
<?php elseif($attack_type == 'satellite'):?>
				...
				<div class="container2">
					...
					<td style="text-align:center">
						...
						<?php $member_data = get_userdata($defender_id[0]);?>
						You fired a satellite at <?php echo clan_tag($member_data->ID);?>
						<a href="/users/profile/?id=<?php echo $member_data->ID;?>">
							<?php echo $member_data->display_name.' (#'.$member_data->ID.')';?></a> 
							and you 
...
?>
				...
				<table class="responsive-table">
					...
					<td style="max-width: 280px;"><?php $member_data = get_userdata($defender_id[0]);?>
						...
						You sent a thief to <?php echo clan_tag($member_data->ID);?> <a href="/users/profile/?id=<?php echo $member_data->ID;?>">
							<?php echo $member_data->display_name.' (#'.$member_data->ID.')';?></a> 

...
<div class="title_wrapper container">
            ...
            <div class="col-lg-12">
             ...
             <h1>Spy reports for <?php if(is_page(47273)):  $user__ID = $_GET['id']; $user = get_userdata($user__ID); $last_online = get_user_meta($user__ID, 'last_online');
        ...
        <div class="after-nav ">
            ...
            <table class="statsmobile" style="border:none;width:350px;margin-left:auto;margin-right:auto;">
	            <tr>
		            <td width="50%">
			         <a href="/events/incoming/"><?php if($new_events[0] > 0):?> <span style="color:#ff0000"><?php echo $new_events[0];?></span> new event<?php if($new_events[0] > 1 || $new_events[0] == 0){echo 's';}?> <?php else:?> <?php echo $new_events[0];?> new event<?php if($new_events[0] > 1 || $new_events[0] == 0){echo 's';}?> <?php endif;?></a><hr/>
		            ...
		            <td width="50%"><a href="/inbox/"><?php if($new_messages[0] > 0):?> <span style="color:#ff0000"><?php echo $new_messages[0];?></span> new message<?php if($new_messages[0] > 1 || $new_messages[0] == 0){echo 's';}?> <?php else:?> <?php echo $new_messages[0];?> new message<?php if($new_messages[0] > 1 || $new_messages[0] == 0){echo 's';}?> <?php endif;?></a><hr/>

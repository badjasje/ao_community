            ...
            <div class="tab_parent_parent ualParentTabs">
                <h2 class="nav-tab-wrapper nav-tab-wrapper">
                    ...
                    <a class="nav-tab ualUserSettings" data-href="ualUserSettings" href="javascript:void(0)">
                        <?php _e('User settings', 'user_activity_log_pro'); ?>
                    </a>
        ...
        <div class="wrap">
            ...
            <form class="sol-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?" . $_SERVER['QUERY_STRING']); ?>">
                <div class="sol-box-border">
                    <h3 class="sol-header-text"><?php _e('Select Users/Roles', 'user_activity_log'); ?></h3>
                    <p><?php _e('Email will be sent upon login of these selected users/roles.', 'user_activity_log'); ?></p>
                    <!-- Search Box start -->
                    <?php if ($display == 'users') {
                        ...
                        <div class="sol-search-user-div">
                            <p class="search-box">
                                ...
                                <input id="search-submit" class="button" type="submit" value="<?php esc_attr_e('Search', 'user_activity_log'); ?>" name="btnSearch_user_role">
                            </p>
                        </div>
                    <?php }
                    ?>
                    ...
                    <div class="tablenav top <?php if ($display == 'roles') echo 'sol-display-roles'; ?>">
                        ...
                        <div class="alignleft actions sol-dropdown">
                            <select name="user_role">
                                <option selected value="roles"><?php _e('Role', 'user_activity_log'); ?></option>
                                <option <?php selected($display, 'users'); ?> value="users"><?php _e('User', 'user_activity_log'); ?></option>
                            </select>
                        </div>
                        ...
                        <div class="tablenav-pages">
                            ...
                            ?>>
                                <span class="pagination-links">
                                    ...
                                    <?php } else { ?>
                                        <a class="first-page <?php if ($paged == '1') echo 'disabled'; ?>" href="<?php echo '?page=general_settings_menu&paged=1&display=' . $display . '&txtsearch=' . $search; ?>" title="Go to the first page">&laquo;</a>
                                        <a class="prev-page <?php if ($paged == '1') echo 'disabled'; ?>" href="<?php echo '?page=general_settings_menu&paged=' . $prev_page . '&display=' . $display . '&txtsearch=' . $search; ?>" title="Go to the previous page">&lsaquo;</a>
                                    <?php } ?>
                                    <span class="paging-input">
                                        <input class="current-page" type="text" size="1" value="<?php echo $paged; ?>" name="paged" title="Current page"> <?php _e('of', 'user_activity_log'); ?>
                                        <span class="total-pages"><?php echo $total_pages; ?></span>
                                    </span>
                                    <a class="next-page <?php if ($paged == $total_pages) echo 'disabled'; ?>" href="<?php echo '?page=general_settings_menu&paged=' . $next_page . '&display=' . $display . '&txtsearch=' . $search; ?>" title="Go to the next page">&rsaquo;</a>
                                    <a class="last-page <?php if ($paged == $total_pages) echo 'disabled'; ?>" href="<?php echo '?page=general_settings_menu&paged=' . $total_pages . '&display=' . $display . '&txtsearch=' . $search; ?>" title="Go to the last page">&raquo;</a>
                                </span>
                            </div>
                        </div>
                        <!-- top pagination end -->
                    ...
                    ?>">
                        <thead>
                            <tr>
                                ...
                                <th width="50px" scope="col"><?php _e('No.', 'user_activity_log'); ?></th>
                                <th scope="col"><?php _e('User', 'user_activity_log'); ?></th>
                                <th scope="col"><?php _e('First name', 'user_activity_log'); ?></th>
                                <th scope="col"><?php _e('Last name', 'user_activity_log'); ?></th>
                                <th scope="col" class="role-width"><?php _e('Role', 'user_activity_log'); ?></th>
                                <th scope="col" class="email-id-width"><?php _e('Email address', 'user_activity_log'); ?></th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                        ...
                        <tbody>
                            ...
                            if ($get_user_data) {
                                ...
                                echo '<td class="colspanchange" colspan="4">' . __('No record found.', 'user_activity_log') . '</td>';
                                echo '</tr>';
                            }
                            ?>
                        </tbody>
                    ...
                    ?>">
                        <thead>
                            <tr>
                                <th scope="col" class="check-column"><input type="checkbox" /></th>
                                <th scope="col"><?php _e('No.', 'user_activity_log'); ?></th>
                                <th scope="col"><?php _e('Role', 'user_activity_log'); ?></th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                        ...
                        <tbody>
                            ...
                            if ($get_data) {
                                ...
                                echo '<tr class="no-items">';
                                echo '<td class="colspanchange" colspan="3">' . __('No record found.', 'user_activity_log') . '</td>';
                                echo '</tr>';
                            }
                            ?>
                        </tbody>
                    ...
                    ?>
                    <p class="submit">
                        <input id="submit" class="button button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'user_activity_log'); ?>" name="saveLogin">
                    </p>
                </div>
            </form>
...
if (!function_exists('ual_email_settings')):
    ...
    function ual_email_settings() {
        ...
        $mail_msgs = __('Hi ', 'user_activity_log');
        $mail_msgs .= sprintf(__('%s,', 'user_activity_log'), $current_user->display_name);
        $mail_msgs .= "\n\n" . __("Following user is logged in your site", 'user_activity_log') . " \n$user_details";
        $mail_msgs .= "\n\n" . __("Thanks, \n", 'user_activity_log');
        $mail_msgs .= home_url();
        ...
        if (isset($_POST['btnsolEmail']) && isset($_POST['_wp_email_nonce']) && wp_verify_nonce($_POST['_wp_email_nonce'], '_wp_email_action')) {
            ...
            if (isset($_POST['emailEnable'])) {
                if ($_POST['emailEnable'] == '1') {
                    if ($mail_msg == "") {
                        $msg = __("Please enter message", 'user_activity_log');
                        $class = "error";
                    } else if ($to_email == "" || $from_email == "") {
                        $msg = __("Please enter the email address", 'user_activity_log');
                        $class = "error";
                        ...
                        $msg = __("Please enter valid email address", 'user_activity_log');
                        $class = "error";
                    } else {
                        update_option('to_email', $to_email);
                        update_option('from_email', $from_email);
                        update_option('email_message', $mail_msg);
                        $msg = __("Settings saved successfully.", 'user_activity_log');
                        $class = "updated";
                    }
                }
            }
        ...
        <div class="wrap">
            ...
            <form method="POST" class="sol-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?" . $_SERVER['QUERY_STRING']); ?>">
                <div class="sol-box-border">
                    <h3 class="sol-header-text"><?php _e('Email', 'user_activity_log'); ?></h3>
                    <p class="margin_bottom_30"><?php _e('This email will be sent upon login of selected users/roles.', 'user_activity_log'); ?></p>
                    <table class="sol-email-table" cellspacing="0">
                        <tr>
                            <th><?php _e('Enable?', 'user_activity_log'); ?></th>
                            <td>
                                ...
                                <label class="ui-button ui-widget ui-state-default ui-button-text-only ui-corner-left" for="enableEmail" role="button">
                                    <span class="ui-button-text"><?php _e('Yes', 'user_activity_log'); ?></span>
                                </label>
                                ...
                                <label class="ui-button ui-widget ui-state-default ui-button-text-only ui-corner-right"for="disableEmail" role="button">
                                    <span class="ui-button-text"><?php _e('No', 'user_activity_log'); ?></span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <th><?php _e('From Email', 'user_activity_log'); ?></th>
                            <td>
                                <input type="email" name="sol-mail-from" value="<?php echo $from_email; ?>">
                                <p class="description"><?php _e('The source Email address', 'user_activity_log'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th><?php _e('To Email', 'user_activity_log'); ?></th>
                            <td>
                                <input type="email" name="sol-mail-to" value="<?php echo $to_email; ?>">
                                <p class="description"><?php _e('The Email address notifications will be sent to', 'user_activity_log'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th><?php _e('Message', 'user_activity_log'); ?></th>
                            <td>
                                <textarea cols="50" name="sol-mail-msg" rows="5"><?php echo $mail_msg; ?></textarea>
                                <p class="description"><?php _e('Customize the message as per your requirement', 'user_activity_log'); ?></p>
                            </td>
                        </tr>
                    </table>
                    <?php
                    ...
                    ?>
                    <p class="submit">
                        <input class="button button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'user_activity_log'); ?>" name="btnsolEmail">
                    </p>
                </div>
            </form>
            <?php ual_advertisment_sidebar(); ?>
    ...
    function ual_send_email($login) {
        ...
        for ($i = 0; $i < count($enable_unm); $i++) {
            if ($enable_unm[$i] == $current_user) {
                ...
                $user_firstnm = !empty($firstname) ? sprintf(__('%s', 'user_activity_log'), ucfirst($firstname)) : "-";
                $user_lastnm = !empty($lastname) ? sprintf(__('%s', 'user_activity_log'), ucfirst($lastname)) : "-";
                ...
                $user_reg = sprintf(__('%s', 'user_activity_log_pro'), $date);
                $user_reg .= " ";
                $user_reg .= sprintf(__('%s', 'user_activity_log_pro'), $time);
                ...
                $user_details = "<table cellspacing='0' border='1px solid #ccc' class='sol-msg' style='margin-top:30px'>
                                <tr>
                                    <td style='padding:5px 10px;'>" . __('Username', 'user_activity_log') . "</td>
                                    <td style='padding:5px 10px;'>" . __('Firstname', 'user_activity_log') . "</td>
                                    <td style='padding:5px 10px;'>" . __('Lastname', 'user_activity_log') . "</td>
                                    <td style='padding:5px 10px;'>" . __('Email', 'user_activity_log') . "</td>
                                    <td style='padding:5px 10px;'>" . __('Date Time', 'user_activity_log') . "</td>
                                    <td style='padding:5px 10px;'>" . __('IP address', 'user_activity_log') . "</td>
                                </tr>
                                <tr>
                ...
                if ($to_email != "" && $mail_msg != "" && $from_email != "") {
                    ...
                    wp_mail($to_email, __('User Login Notification', 'user_activity_log'), $mail_msg, $headers);
                }
            }
        }
    }
...
//                $wpdb->query("DELETE FROM $table_nm WHERE modified_date < NOW() - INTERVAL $time_ago DAY");
        ...
        <div class="wrap">
            ...
            <form class="sol-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?" . $_SERVER['QUERY_STRING']); ?>" method="POST" name="general_setting_form">
                <div class="sol-box-border">
                    <h3 class="sol-header-text"><?php _e('Display Option', 'user_activity_log'); ?></h3>
                    <p class="margin_bottom_30"><?php _e('There are some basic options for display User Action Log', 'user_activity_log'); ?></p>
                    <table class="sol-email-table">
                        <tr>
                            <th><?php _e('Keep logs for', 'user_activity_log'); ?></th>
                            <td>
                                <input type="number" step="1" min="1" placeholder="30" value="<?php echo $log_day; ?>" name="logdel">&nbsp;<?php _e('Days', 'user_activity_log'); ?>
                                <p><?php _e('Maximum number of days to keep activity log. Leave blank to keep activity log forever (not recommended).', 'user_activity_log'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th><?php _e('Delete Log Activities', 'user_activity_log'); ?></th>
                            <td>
                                <?php $nonce = wp_create_nonce('my-nonce'); ?>
                                <a href="?page=general_settings_menu&db=reset&_wpnonce=<?php echo $nonce; ?>" onClick="return confirm('<?php _e('Are you sure want to Reset Database?', 'user_activity_log'); ?>');"><?php _e('Reset Database', 'user_activity_log'); ?></a>
                                <p><span class="red"><?php _e('Warning: ', 'user_activity_log'); ?></span><?php _e('Clicking this will delete all activities from the database.', 'user_activity_log'); ?></p>
                            </td>
                        </tr>
                    </table>
                    <p class="submit">
                        <input id="submit" class="button button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'user_activity_log'); ?>" name="submit_display">
                    </p>
                </div>
            </form>
            <?php ual_advertisment_sidebar(); ?>

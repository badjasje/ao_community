<?php
/*
Plugin Name: Profile Builder Hobbyist
...
function wppb_hobbyist_plugin_init() {
    if (function_exists('wppb_return_bytes')) {
         ...
         *
         */
        define('PROFILE_BUILDER_VERSION', '2.5.9' );
...
} //end wppb_hobbyist_plugin_init
add_action( 'plugins_loaded', 'wppb_hobbyist_plugin_init' );

...
if($freeland < 0){$_SESSION['status'] = '4';wp_redirect($exploreUrl); exit;}
if($_POST['land'] < 0){$_SESSION['status'] = '12';wp_redirect($exploreUrl); exit;}
if(!is_numeric($_POST['land'])){$_SESSION['status'] = '12';wp_redirect($exploreUrl); exit;}

if($_POST['land'] > $freeland){$_SESSION['status'] = '12';wp_redirect($exploreUrl); exit;}

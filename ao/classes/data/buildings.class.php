...
class Buildings extends DataObject {
    ...
    static $data = array(
        ...
        'samsite'           => array(
            ...
            'normalname'    =>  'SAM Site',
            'targetname'    =>  'defense',
            'description'   =>  'Sam sites defend against air units.',
            'attacks'       =>  array('air'),
            'attack'        =>  225,
            'type'          =>  'bds',
            'powerprod'     =>  0,
        ...
        'antimissile'       => array(
            ...
            'targetname'    =>  'ams',
            'description'   =>  'Each Anti-Missile System protects 100m2 of your built land. Chance to shoot down missiles is currently 0%.',
            'attacks'       =>  array('mis'),
            'attack'        =>  0,
            'type'          =>  'bds',
            'powerprod'     =>  0,
